            ...
            <div class="col-lg-4">
                <div class="cart__total">
                    ...
                    <form id="checkout-form" method="get">
                        ...
                        <input type="hidden" id="form-action" name="form_action" value="">
                        <button type="button" class="primary-btn mt-2 btn-block" onclick="submitForm('checkout')">Cash On Delivery</button>
                        <button type="button" class="primary-btn mt-2 btn-block" onclick="submitForm('stripe')">Pay Online</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    function submitForm(action) {
        ...
        form.action = action === 'checkout' ? "{{ URL::to('checkout') }}" : "{{ URL::to('stripe') }}";
        form.method = 'get';
        form.submit();
    }
</script>
