  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="Dashboard/index.html"><h6><i>NMPI</i></h6></a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav mx-auto"> <!-- mx-auto class horizontally centers the content -->
        <li class="nav-item">
            <h3 style="color: #000080;">Welcome to Admin Dashboard</h3>
        </li>
        </ul>
